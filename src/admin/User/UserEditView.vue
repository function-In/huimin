            ...
            <el-main>
                <el-form :model="table" ref="UserEditDom" label-width="100px">
                    <el-form-item label="用户编号">
                        <el-input v-model="table.id" disabled></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="头像">
                        ...
                        <div style="margin-left: 20px;display: flex;flex-direction: row;align-items: normal;">
                            原头像
                            <img :src="Axios.address + table.user_header" alt=""
                    ...
                    <el-form-item label="注册时间">
                        <el-input v-model="table.user_time" disabled></el-input>
                    </el-form-item>
...
Axios.Post(undefined,
    [{ name: 'meta', value: 'user_info_require2' }, { name: 'userid', value: userid }],
    (result) => {
        if (result.data.code == 200) table.value = result.data.data[0];
        else notify('info', result.data.code + '', result.data.info);
    },
